...
require (
	...
	git.xiaojukeji.com/devops/statsd v0.3.2 // indirect
	git.xiaojukeji.com/disf/disf-go-spl-v2 v0.1.60 // indirect
	git.xiaojukeji.com/disfv4/commlib v0.0.0-20230515071326-a183b2265970 // indirect
	...
	git.xiaojukeji.com/gobiz/logger v1.5.7 // indirect
	...
	git.xiaojukeji.com/nuwa/trace/v2 v2.0.3 // indirect
	git.xiaojukeji.com/observe-trace/didi-open-telemetry/opentelemetry-go v1.0.0 // indirect
	git.xiaojukeji.com/pearls/tlog v0.1.0 // indirect
	git.xiaojukeji.com/platform-ha/nodemgr-go v1.0.0 // indirect
	git.xiaojukeji.com/sre-ha/chaos-sdk-go v1.0.2 // indirect
