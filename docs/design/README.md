...
| [`ai-cool-source-expansion-technical-solution.md`](./ai-cool-source-expansion-technical-solution.md) | AI Cool 信息源扩展的技术方案，覆盖架构、数据、接口、前端、上线回滚和验收 | 评审或交接第四部分信息源扩展实现方案时 |
